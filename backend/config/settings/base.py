...
PROJECT_DIR = ROOT_DIR.path("backend")
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres://localhost/backend")}
...
FIXTURE_DIRS = (str(PROJECT_DIR.path("fixtures")),)
...
ADMINS = [("""Marc Skov Madsen""", "marc.skov.madsen@gmail.com")]
